      ...
      <div>
        ...
        <div className="grey-body">
          ...
          <div className="teeter-text">
            <p className="t-text">The solution is toleration.</p>
          ...
          <p>
            ...
            By adding friction in the form of contemplation, we can integrate
            our point of view with the opposing point of view.
            <br />
            <br />
            <br />
            <br />
        ...
        <div className="how">
          ...
          <div className="how-steps">
            ...
            <p>
              ▲ Take a moment to think about an alternative or opposing point of
              view.
            </p>
            <p>
              ◑ Clearly state the alternative position and how strongly you
              agree with it.
            </p>
            <p>
              ◉ Copy and paste the Tolero formatted protocol and post it
              anywhere.
            </p>
            <br />
            <br />
        ...
        <div className="post-it">
          <p>
            Post your Tolero anywhere, adding nuance and depth to what you
            share.
          </p>
        </div>
        <div className="btn-container">
          <button className="begin" onClick={this.props.beginButton}>
            Begin
          </button>
        </div>
      </div>
